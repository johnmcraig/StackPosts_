<template>
    ...
    <b-form @submit.prevent="OnSubmit" @reset.prevent="onCancel">
        <b-form-group label="Title:" label-for="titleInput">
            <b-form-input id="titleInput" type="text" v-model="form.title" required placeholder="Please provide a title">
            </b-form-input>
        </b-form-group>
        <b-form-group>
            <b-form-textarea id="postInput" v-model="form.body" placeholder="What do you want to write about?" :rows="6" :max-rows="10">
            </b-form-textarea>
        </b-form-group>
